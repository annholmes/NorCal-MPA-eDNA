...
path <- "~/Desktop/CCFRP_2021/MiFish_tank_NC/MiFish_tank_NC_fastq"
...
taxa <- assignTaxonomy(seqtab.nochim, "~/Desktop/CCFRP_2021/MiFish_tank_NC/MiFish_RDB.txt", multithread=TRUE, tryRC=TRUE)
...
write_xlsx(df, "~/Desktop/CCFRP_2021/MiFish_tank_NC/MiFish_tank_NC_tax.xlsx")
