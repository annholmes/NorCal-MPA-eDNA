...
path <- "~/Desktop/CCFRP_2021/MiFish_tank_MC/MiFish_tank_MC_fastq"
...
taxa <- assignTaxonomy(seqtab.nochim, "~/Desktop/CCFRP_2021/MiFish_tank_MC/MiFish_RDB.txt", multithread=TRUE, tryRC=TRUE)
...
df$ASV <- rownames(df)
write_xlsx(df, "~/Desktop/CCFRP_2021/MiFish_tank_MC/MiFish_tank_MC_taxonomy.xlsx")

# phyloseq
metadata <- read.csv("MiFish_MC_map.csv")
...
write_xlsx(df, "~/Desktop/CCFRP_2021/MiFish_tank_MC/MiFish_tank_MC_abun.xlsx")
